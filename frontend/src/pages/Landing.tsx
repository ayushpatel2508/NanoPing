...
export default function Landing() {
  ...
  useEffect(() => {
    // Simulate initial mount loading for skeleton demonstration
    ...
    <div className="min-h-screen bg-[#0f1115] font-sans text-slate-300 selection:bg-emerald-500/30 selection:text-emerald-200 overflow-hidden">
      ...
      <Skeleton name="landing-hero" loading={isLoading}>
        <header className="container mx-auto px-6 pt-32 pb-16 text-center max-w-5xl relative z-10 animate-[fade-in_1.5s_ease-out]">
          ...
          <Link to="/signup" className="inline-block bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-bold py-4 px-12 rounded-full text-lg transition-all shadow-[0_0_30px_rgba(16,185,129,0.4)] hover:shadow-[0_0_50px_rgba(16,185,129,0.7)] hover:scale-105 group relative overflow-hidden">
      ...
      <Skeleton name="landing-mockup" loading={isLoading}>
        <section className="container mx-auto px-6 pb-24 relative z-10">
          <div className="max-w-5xl mx-auto bg-[#13161b] rounded-2xl border border-slate-800/60 shadow-2xl overflow-hidden ring-1 ring-white/5 relative transform hover:scale-[1.01] transition-transform duration-700 ease-out group">
            ...
            <div className="p-8 flex flex-col md:flex-row gap-8 bg-gradient-to-b from-[#13161b] to-[#0a0c0f] relative overflow-hidden">
              ...
              {/* Sidebar Mock (Foreground) */}
              <div className="hidden md:flex flex-col gap-4 w-48 shrink-0 relative z-20">
              ...
              <div className="flex-1 space-y-6 relative z-20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-[#1a1c23]/80 backdrop-blur-sm p-4 rounded-xl border border-slate-800/50 hover:bg-[#20222a] hover:-translate-y-1 transition-all duration-300 cursor-default shadow-lg">
                  ...
                  <div className="bg-[#1a1c23]/80 backdrop-blur-sm p-4 rounded-xl border border-slate-800/50 hover:bg-[#20222a] hover:-translate-y-1 transition-all duration-300 cursor-default shadow-lg group-hover:border-slate-700">
      ...
      {/* Features Section */}
      <Skeleton name="landing-features" loading={isLoading}>
        <section id="features" className="bg-[#0f1115] py-24 relative z-10 border-t border-slate-800/30">
      ...
      {/* Status Page Demo Section */}
      <Skeleton name="landing-status-demo" loading={isLoading}>
        <section id="status-demo" className="bg-[#0b0c10] border-y border-slate-800/50 py-32">
          <div className="container mx-auto px-6 max-w-6xl">
      ...
      <section className="bg-gradient-to-b from-[#0b0c10] to-[#0f1115] py-24 text-center">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <p className="text-lg text-slate-400 mb-10 max-w-2xl mx-auto">
            There’s nothing to install. No credit card required. 5 monitors for free. Get total peace of mind today.
          </p>
